...
router.all("/books/new", (req, res, next) => BooksController.new(req, res, next))
router.all("/books/:id", (req, res, next) => BooksController.book(req, res, next))
router.post("/books/:id/delete", (req, res, next) => BooksController.delete(req, res, next))
